...
\[
B_{r_i}(a_i)\subseteq A.
\]
Hence
\[
\bigcup_{i\in I} B_{r_i}(a_i)\subseteq A.
\]
On the other hand, if $x\in A$, then taking $i=x\in I$ gives
\[
x=a_i\in B_{r_i}(a_i),
\]
since $d(a_i,a_i)=0<r_i$. Therefore
\[
A\subseteq \bigcup_{i\in I} B_{r_i}(a_i).
\]
